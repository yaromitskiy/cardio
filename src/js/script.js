...
class App {
  ...
  _loadMap(position) {
    ...
    // Отображение тренировок из LocalSorage на карте
  ...
  _newWorkout(e) {
    ...
    // Если тренеровка является пробежкой, создать объект Runnig
    ...
    // Если тренеровка является велотренировкой, создать объект Cycling
    ...
    // Добавить новый объект в масси тренровок
    ...
    // Дгобавить все тренировки в локальное хранилище
